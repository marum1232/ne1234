    ...
    <OverlayShell>
      <div style={{ textAlign: "center", marginBottom: 28 }}>
        <div style={{
          ...
          <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke={theme.surface} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <div style={{ textAlign: "center" }}>
          ...
          {(supportPhone || supportEmail) && (
            <div style={{
              ...
              <p style={{ color: theme.primary, fontSize: 11, fontWeight: 700, letterSpacing: "0.07em", textTransform: "uppercase", margin: "0 0 6px" }}>
                Emergency Contact
              </p>
